...
contract MockToken is IERC20 {
    ...
    function burn(address account, uint256 amount) external {
        require(_balances[account] >= amount, "MockToken: Insufficient balance");
        _balances[account] -= amount;
        _totalSupply -= amount;
    ...
    function transfer(address to, uint256 amount) external override returns (bool) {
        require(_balances[msg.sender] >= amount, "MockToken: Insufficient balance");
    ...
    function transferFrom(address from, address to, uint256 amount) external override returns (bool) {
        ...
        require(_allowances[from][msg.sender] >= amount, "MockToken: Insufficient allowance");
